...
const _sfc_main = {
  ...
  created() {
    if (!(common_vendor.Bs.config && common_vendor.Bs.config.provider)) {
      this.noSpace = true;
      common_vendor.Bs.chooseAndUploadFile = common_vendor.chooseAndUploadFile;
    }
  ...
  methods: {
    ...
    async getTempFileURL(fileList) {
      ...
      const urls = await common_vendor.Bs.getTempFileURL(fileList);
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "C:/Users/iyunk/Desktop/WOrk/ph_bs/bs/node_modules/@dcloudio/uni-ui/lib/uni-file-picker/uni-file-picker.vue"]]);
